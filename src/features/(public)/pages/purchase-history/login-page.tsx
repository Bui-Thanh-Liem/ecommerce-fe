    ...
    <div className="grid grid-cols-12 py-12">
      ...
      {customer ? (
        <div className="col-span-8 flex h-[calc(100vh-300px)] items-center justify-center gap-x-20">
          <p>Đang tải thông tin tài khoản và lịch sử mua hàng của bạn</p>
        </div>
      ) : (
        <div className="col-span-8 flex h-[calc(100vh-300px)] items-center justify-center gap-x-20">
          <svg
          ...
          >
            ...
            <g
              transform="translate(290, 390) rotate(-20)"
          ...
          <Card className="mr-54 text-center">
            ...
            <CardContent className="space-y-8">
              ...
              <CardDescription>
                Nhấn “Tiếp tục” đồng nghĩa với việc bạn cho phép hệ thống gửi
                tin nhắn xác thực đến số điện thoại trên
              </CardDescription>
            </CardContent>
          </Card>
        </div>
