    ...
    <div className="flex h-[calc(100vh-200px)] flex-col items-center justify-center">
      ...
      >
        ...
        <g id="shopping-basket">
          ...
          {/* 5 lỗ dọc màu trắng */}
          <rect x="350" y="380" width="12" height="60" rx="6" fill="#FFFFFF" />
          <rect x="382" y="380" width="12" height="65" rx="6" fill="#FFFFFF" />
          <rect x="414" y="380" width="12" height="65" rx="6" fill="#FFFFFF" />
          <rect x="446" y="380" width="12" height="65" rx="6" fill="#FFFFFF" />
          <rect x="478" y="380" width="12" height="60" rx="6" fill="#FFFFFF" />

          {/* Vành giỏ màu xanh dương */}
          <rect x="300" y="335" width="240" height="26" rx="8" fill="#3B82F6" />
