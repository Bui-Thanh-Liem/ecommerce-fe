...
export function MktProgramSelectInForm({
  form,
  max = 5,
  ...
  const comboboxOptions = mktProgramsData.map(
    (mktProgram: IMarketingProgram) => ({
      value: mktProgram.id,
      label: mktProgram.name,
      image: mktProgram.mainImage,
    })
  )
        ...
        render={({ field, fieldState }) => (
          <Field data-invalid={fieldState.invalid}>
            ...
            <CustomCombobox
              ...
              placeholder={
                multiple
                  ? "Select marketing programs..."
                  : "Select a marketing program..."
              }
              searchPlaceholder="Search marketing program name..."
